 ...
 * @author SIDAM
 */
public class Penyetokan extends ProducFlow{
    int lastid;
    ...
    public int getLastid() {
        ...
        try{
            int no = 1;
            String sql = "SELECT id_transaksi FROM transaksi_beli ORDER BY id_transaksi DESC LIMIT 1";
    ...
    public void tambahDetail(int newido, int newjumlah, int newharga) {
         ...
         try{   
          ...
          try{   
            ...
            String sql = "INSERT INTO beli VALUES(NULL,'"+newido+"','"+lastid+"','"+newjumlah+"','"+newharga+"')";
            java.sql.Connection db = (Connection) Koneksi.configDB();
            java.sql.PreparedStatement pstm = db.prepareStatement(sql);
            pstm.execute();
    ...
    public void tambahData(String newnama, int newtharga) {
        //To change body of generated methods, choose Tools | Templates.
         try{   
            String sql = "INSERT INTO transaksi_beli VALUES(NULL,'"+newnama+"','"+newtharga+"')";
            java.sql.Connection db = (Connection) Koneksi.configDB();
            java.sql.PreparedStatement pstm = db.prepareStatement(sql);
            pstm.execute(); 
